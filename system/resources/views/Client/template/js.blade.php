  <script src="{{url('public')}}/Client/assets/vendor/aos/aos.js"></script>
  ...
  <script src="{{url('public')}}/Client/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  ...
  <script src="{{url('public')}}/Client/assets/vendor/waypoints/noframework.waypoints.js"></script>
